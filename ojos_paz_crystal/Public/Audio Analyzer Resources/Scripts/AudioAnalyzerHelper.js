...
//@input Asset.VFXAsset drumAsset
...
function initialize() {
    ...
    analyzer = script.audioAnalyzerScript.api;
...
//                asset = script.drumAsset.properties  //script.asset.properties;
//            } else {
...
//                return false;
//            }
        asset = script.drumAsset.properties
...
function callApiFunction(v) {
    script.scriptWithApi.api[script.functionName](v);
}
//set asset property
